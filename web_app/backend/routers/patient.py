    ...
    try:
        ...
        if req.requires_ambulance:
            ...
            if driver:
                ...
                try:
                    from backend.routers.driver import active_dispatches
                    active_dispatches[driver['driver_id']] = {
                        "patient_name": req.name,
                        "hospital_name": h_rec['name'] if h_rec else "Hospital",
                        "contact_number": p_rec['contact_number'] if p_rec else "N/A",
