...
async function fetchDispatches() {
    ...
    try {
        ...
        if (disp) {
            ...
            const routeBtn = document.getElementById('disp-route');
            ...
            if (disp.patient_lat && disp.patient_lon) {
                ...
                if (routeBtn) routeBtn.href = `https://www.google.com/maps/dir/?api=1&destination=${disp.patient_lat},${disp.patient_lon}&travelmode=driving`;
